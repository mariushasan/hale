...
function AssaultRifle.handleFireFromServer(shooter, bullets)
    ...
    for _, bullet in ipairs(bullets) do
        local updateFunction = AssaultRifle.animateBullet(bulletStartPosition + bullet.animationStartOffset, bullet.hitPosition, bullet.hitPart, bullet.animationDirection)
